		...
		<div class="dashboard-panel-footer">
			...
			<div class="dashboard-panel-toolbar">
				<% if $Dashboard.CanConfigurePanels %>
					<a class="btn-dashboard-panel-configure" href="$ConfigLink"><img src="$resourceURL('sunnysideup/silverstripe-dashboard:images/configure.png')"/></a>
				<% end_if %>
				<% if $Dashboard.CanDeletePanels %>
					<a class="btn-dashboard-panel-delete" href="$DeleteLink"><img src="$resourceURL('sunnysideup/silverstripe-dashboard:images/trash.png')"/></a>
				<% end_if %>
			</div>
		</div>
